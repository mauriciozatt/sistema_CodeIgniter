...
<html lang="en">
   ...
   <body>
      ...
      <?php
         ...
         $sql = "SELECT * FROM produto WHERE idproduto='$vcodigo'";
      ...
      <div class="row clearfix">
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
               ...
               <div class="body">
                  <form class="form-horizontal" name="formulario"  action="../atualiza/atualizarproduto"  method="POST" role="form">
                     <div class="row clearfix">
                     ...
                     <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                           <div class="form-group">
                              <div class="form-line">
 <input type="text" id="nome" name="nome" class="form-control" placeholder="Informe a nome"value="<?php echo $vnome?>"disabled>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                           <div class="form-group">
                              <div class="form-line">
 <input type="text" id="valor" name="valor" class="form-control" placeholder="Informe a valor"value="<?php echo $vvalor?>"disabled>
                              </div>
                           </div>
                        </div>
                     </div>
 ...
 <a href="<?php echo "../excluir/excluirproduto?codigo=$vcodigo";?>">
